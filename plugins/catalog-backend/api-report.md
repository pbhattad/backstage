...
export const conditions: {
  hasAnnotation: (
    annotation: string,
  ) => PermissionCondition<[annotation: string]>;
  isEntityKind: (kinds: string[]) => PermissionCondition<[kinds: string[]]>;
  isEntityOwner: (claims: string[]) => PermissionCondition<[claims: string[]]>;
};
...
// Warning: (ae-missing-release-tag) "registerPermissionRule" is exported by the package, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
